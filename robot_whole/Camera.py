...
class Camera_init(object):
	...
	def use_Camera(self,i):
		...
		photo = imutils.resize(photo,width=1080)
		# print("ok")
		ret, photo = self.cap.read()		# 读取图像
		photo = imutils.resize(photo,width=1080)
		# print("ok")
...
if __name__ == '__main__':
	...
	path = ['image/image_goods/1.jpg','image/image_goods/2.jpg','image/image_goods/3.jpg','image/image_goods/4.jpg']
	camera.split_Camera1(path)